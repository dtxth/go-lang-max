...
✅ **Логирование паролей** - Автоматический вывод паролей и токенов сброса в консоль для администраторов  
...
# Обязательно измените секреты для production!
```
...
**Документация:**
- [Testing and Deployment Guide](./TESTING_AND_DEPLOYMENT.md) - Полное руководство по тестированию и развертыванию
- [Docker Cross-Service Dependencies](./DOCKER_CROSS_SERVICE_DEPENDENCIES.md) - Подробное описание решения проблем со сборкой
- [Docker Build Quick Start](./DOCKER_BUILD_QUICK_START.md) - Быстрые команды для работы с Docker

**Размеры образов:**
- auth-service: 36.9MB
- chat-service: 37.9MB
- employee-service: 37.9MB
- structure-service: 40.8MB
- maxbot-service: 25.8MB
...
- [Admin Password Guide](./docs/ADMIN_PASSWORD_GUIDE.md) - **Руководство администратора по получению паролей из логов**
- [Password Logging Implementation](./docs/PASSWORD_LOGGING_IMPLEMENTATION.md) - Техническая документация по логированию паролей
- [Password Management Configuration](./auth-service/PASSWORD_MANAGEMENT_CONFIG.md) - Настройка управления паролями
